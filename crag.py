...
class MooligAI:
    ...
    def web_search(self, query, num_results=3):
        ...
        try:
            ...
            return "Unable to retrieve web search results at this time."
    ...
    if prompt1:
        with st.spinner("Processing your query..."):
            try:
                ...
                st.info("Please try restarting the application or reformulating your query.")
